...
module.exports = {
  saveJSONFile: function (objectToSave, filePath) {
    try {
      const jsonString = JSON.stringify(objectToSave, null, 2); // Convert object to JSON string with indentation
      //   fs.writeFileSync(filePath, jsonString); // Write JSON string to file
      fs.writeFile(filePath, jsonString, {}, () => {}); // Write JSON string to file
